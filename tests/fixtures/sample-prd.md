...
Teams struggle to coordinate work across multiple projects. Current solutions are either too complex for small teams or lack essential features like [TBD: specific features to highlight].
...
- [TBD: What other user roles should we target?]
...
- Assignee
- [TBD: Should we include custom fields?]

### 4.2 Project Organization

Projects group related tasks together. Key questions:
- How should we handle task dependencies? [TBD]
- What is the maximum project hierarchy depth? [TBD: recommend 3 levels]
...
- Web (modern browsers)
- Mobile ([TBD: iOS only initially or both iOS and Android?])

### 5.2 Performance

- Page load time: < 2 seconds
- API response time: < 500ms
- [TBD: What is the target concurrent user capacity?]

### 5.3 Integration

Integration points to be determined:
- Calendar sync: [TBD: Google Calendar, Outlook, or both?]
...
| Metric | Target | Notes |
|--------|--------|-------|
| User adoption | [TBD: target number] | First 90 days |
...
- Phase 1: MVP (Q1 2026)
- Phase 2: Mobile app ([TBD: confirm timeline])
