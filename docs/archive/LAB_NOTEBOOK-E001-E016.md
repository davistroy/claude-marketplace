# Lab Notebook Archive — Entries E001–E016

**Archived:** 2026-07-17
**Source:** `../../LAB_NOTEBOOK.md` (rotated to bound the mandatory first-read size)
**Range:** Entry 001 (2026-04-30) through Entry 016 (2026-07-16)
**Note:** These entries are historical. All decisions they established remain live in the Decision Log of `../../LAB_NOTEBOOK.md` (D1–D31, complete). This file preserves the full experiment narrative; nothing here was deleted.
