...
- `<pattern-type>` - Template pattern: read-only, interactive, workflow, generator, utility
...
Enter number (1-5) or pattern name:
```
...
**Determine output location** (for generators):
