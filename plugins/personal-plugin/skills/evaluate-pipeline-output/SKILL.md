...
Produce the report using the template in `references/report-format.md` (in this skill's own directory), populating every placeholder from the Phase 1-12 analysis.
