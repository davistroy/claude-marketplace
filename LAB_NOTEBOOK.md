...
**Status:** IMPLEMENTATION VERIFIED locally (both tools mypy=0, all tests green); committing + PR next. Updates D24 (baselines reached 0 — objective achieved, not just tightened).
