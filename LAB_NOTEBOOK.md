...
**Status:** IMPLEMENTATION VERIFIED locally (tools pass on 3.10 + 3.12); committing + PR next. After merge: confirm `Python Compat (3.10)`/`(3.12)` appear as NON-required checks and the 14 required contexts are unchanged.
